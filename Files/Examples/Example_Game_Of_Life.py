...
# SH1106 is vertically oriented 64x128
WIDTH = 128
HEIGHT = 64
...
while True:
    ...
    for _ in range(n):
        ...
        display.root_group = g2  # Replace display.show(g2) with this
        apply_life_rule(b2, b1)

    # After 2*n generations, fill the board with random values and start over.
    randomize(b1)
